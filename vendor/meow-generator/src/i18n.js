...
const COPY = {
  ...
  '预设保存': { 'ja-JP': 'プリセット保存', en: 'Save presets' },
  '预设名称': { 'ja-JP': 'プリセット名', en: 'Preset name' },
  '保存当前猫咪': { 'ja-JP': '現在のねこを保存', en: 'Save current kitten' },
  '跨端同步': { 'ja-JP': 'デバイス間同期', en: 'Cross-device sync' },
  '同步码': { 'ja-JP': '同期コード', en: 'Sync code' },
  '20 位同步码': { 'ja-JP': '20文字の同期コード', en: '20-character sync code' },
  '连接同步': { 'ja-JP': '同期に接続', en: 'Connect sync' },
  '生成同步码': { 'ja-JP': '同期コードを生成', en: 'Generate code' },
  '立即同步': { 'ja-JP': '今すぐ同期', en: 'Sync now' },
  '断开': { 'ja-JP': '切断', en: 'Disconnect' },
  '复制': { 'ja-JP': 'コピー', en: 'Copy' },
  '还没有保存的猫咪': { 'ja-JP': '保存したねこはまだありません', en: 'No saved kittens yet' },
  '应用': { 'ja-JP': '適用', en: 'Apply' },
  '更新': { 'ja-JP': '更新', en: 'Update' },
  '删除': { 'ja-JP': '削除', en: 'Delete' },
  '请输入预设名称': { 'ja-JP': 'プリセット名を入力してください', en: 'Enter a preset name' },
  '预设已保存': { 'ja-JP': 'プリセットを保存しました', en: 'Preset saved' },
  '同名预设已覆盖': { 'ja-JP': '同名のプリセットを上書きしました', en: 'Preset overwritten' },
  '预设已应用': { 'ja-JP': 'プリセットを適用しました', en: 'Preset applied' },
  '预设名称已更新': { 'ja-JP': 'プリセット名を更新しました', en: 'Preset name updated' },
  '预设参数已更新': { 'ja-JP': 'プリセットのパラメータを更新しました', en: 'Preset parameters updated' },
  '已存在同名预设': { 'ja-JP': '同名のプリセットが既にあります', en: 'A preset with this name already exists' },
  '预设已删除': { 'ja-JP': 'プリセットを削除しました', en: 'Preset deleted' },
  '浏览器无法读取预设': { 'ja-JP': 'ブラウザでプリセットを読み込めません', en: 'Browser could not read presets' },
  '浏览器无法保存预设': { 'ja-JP': 'ブラウザでプリセットを保存できません', en: 'Browser could not save presets' },
