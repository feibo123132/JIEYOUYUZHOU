...
const seed = { version: 1, artistOrder: [song.artist], songOrder: [song.id], customAvatars: {}, avatarAdjustments: {}, catalog: { version: 8, artists: [song.artist], songs: [song] } };
function setup() {
...
test('个人歌单首次复制站主快照，之后双方修改互不影响，重新登录保留删除', async () => {
  ...
  const empty = { ...seed, artistOrder: [], songOrder: [], catalog: { version: 8, artists: [], songs: [] } };
